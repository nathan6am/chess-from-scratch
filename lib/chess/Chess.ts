...
export function move(gameInitial: Game, move: Move, elapsedTimeSeconds?: number): Game {
...
export function gameFromNodeData(
  ...
  return { ...game, board, moveHistory, lastMove: data.move, config: { ...game.config, startPosition } };
}
