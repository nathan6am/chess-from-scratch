...
export interface ClientToServerEvents {
  ...
  "lobby:active": (
    ack: (response: SocketResponse<string | null>) => void
  ) => void;
  "challenge:create": (
    userid: string,
    ack: (response: SocketResponse<{ token: string }>) => void
  ) => void;
  "challenge:cancel": (
    userid: string,
    ack: (response: SocketResponse<never>) => void
  ) => void;
  "challenge:accept": (
    token: string,
    ack: (response: SocketResponse<Lobby>) => void
