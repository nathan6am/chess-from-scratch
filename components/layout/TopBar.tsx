...
export default function TopBar() {
  return (
    <div className="w-full py-3 px-4 bg-elevation-3 rounded-t-lg">
...
const Logo = () => (
  <div className="flex flex-row items-end">
    <h1 className="text-xl font-extrabold text-white flex flex-row items-end">
      <Knight className="fill-gold-200 inline h-8 w-8 ml-4" />
      NextChess
    </h1>
    <p className="text-light-100 text-right font-regular text-xs opacity-10 ml-2 mb-[2px]">
      v 0.1.0
    </p>
  </div>
);
...
const ActionButtons = () => {
  ...
  return (
    <div className="flex flex-row justify-end items-center text-light-100/[0.5]">
