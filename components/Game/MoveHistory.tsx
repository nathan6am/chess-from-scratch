                  ...
                  {moveHistory.map((fullMove, idx) => {
                    ...
                    return (
                      <tr key={idx} className="border-b border-white/[0.1]">
                        <td className="p-2 px-4 w-20 bg-white/[0.1] border-r-2 border-white/[0.2]">{`${idx + 1}.`}</td>
                        <td
                          onClick={() => {
                            controls.jumpToOffset(offset - 1);
                          }}
                          className={`p-2 cursor-pointer ${currentOffset === offset - 1 ? "bg-blue-300/[0.2]" : ""}`}
                        >
                        ...
                        <td
                          ...
                          className={`p-2 cursor pointer ${currentOffset === offset - 2 ? "bg-blue-300/[0.2]" : ""}`}
                        >
